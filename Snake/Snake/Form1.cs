...
namespace Snake
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            gameTimer.Interval = 500 / Settings.Speed * 2;
        ...
        private void movePlayer()
        {
            for (int i = Snake.Count - 1; i >= 0; i--)
            {
                if (i == 0)
                {
                    ...
                    int maxXpos = pb_snakeGame.Size.Width / Settings.Width;
                    int maxYpos = pb_snakeGame.Size.Height / Settings.Height;
        ...
        private void updateGraphics(object sender, PaintEventArgs e)
        {
            ...
            {
                string gameOver = "Game Over n" + "Final Score is " + Settings.Score + "\n Press enter to Restart \n";
                lbl_GameOver.Text = gameOver;
